...
class CenterFace(object):
    def __init__(self, height, width, landmarks=True, model_dir = "/home/robot/gfb/models"):
        self.landmarks = landmarks
        self.net = cv2.dnn.readNetFromONNX(model_dir + '/MASK/centerface.onnx')
    ...
    def __call__(self, img, threshold=0.5):
        ...
        if self.landmarks:
            ...
            return dets    #xmin,ymin,xmax,ymax
